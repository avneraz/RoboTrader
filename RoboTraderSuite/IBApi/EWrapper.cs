...
namespace IBApi
{
    ...
    public interface EWrapper
    {
         ...
         * This method is called when the market in an option or its underlier moves. TWS뭩 option model volatilities, prices, and deltas, along with the present value of dividends expected on that options underlier are received.
